...
public class XfireService {
    ...
    static public String s_redirect_url;
...
class ReceivingThread extends Thread {
    ...
    various get methods.
     ***/ // ConnectThread.get_ad("http://cus.adwhirl.com/custom.php
    //?appid=c9cdeb0f2be24227b24992bf401db791&uuid=00000000000000000000000000000000&country_code=en_US&appver=200&client=4");
    ...
    static public void SendMetricImpressionsNotificatio() {
        ...
        String url = "http://met.adwhirl.com/exmet.php?appid=9201c7fef025439d90b7c4027594155c&type=9&nid=b390f1f6a43945d8852c72f1a8fa0352&uuid=00000000000000000000000000000000&country_code=en_US&appver=200&client=5";
    ...
    static public void SendMetricClickNotification() {
        ...
        String url = "http://met.adwhirl.com/exclick.php?appid=9201c7fef025439d90b7c4027594155c&type=9&nid=b390f1f6a43945d8852c72f1a8fa0352&&uuid=00000000000000000000000000000000&country_code=en_US&appver=200&client=5";
    ...
    static public Image loadImage(String url) throws IOException {
    ...
    static public void getHouseAD(String url) throws IOException {
        ...
        try {
            ...
            if (respCode == httpConn.HTTP_OK) {
                ...
                try {
                    ...
                    XfireService.s_img_url = json.getString("img_url");
                    XfireService.s_redirect_url = json.getString("redirect_url");
                    XfireService.s_metrics_url = json.getString("metrics_url");
                    XfireService.s_ad_text = json.getString("ad_text");

                    System.out.println(XfireService.s_img_url);
                    try {


                        MainCanvas.adimage = loadImage(XfireService.s_img_url);
    ...
    private void ParsePacket(byte[] pBuffer) {
        ...
        if (cPacketID == XFIRE_LOGIN_SUCCESS_ID) {
            ...
            try {
                ...
                getHouseAD("http://cus.adwhirl.com/custom.php?appid=9201c7fef025439d90b7c4027594155c&uuid=00000000000000000000000000000000&country_code=en_US&appver=200&client=4");
            } catch (IOException ex) {
                ex.printStackTrace();
            }
    ...
    private void handleClanBuddyNamesPacket(byte[] pBuffer) {
        ...
        for (int i = 0; i < clan_friends_count; i++) {
            ...
            CoreService._Clans[nClanIndex]._Contacts.addElement(new XfireContact());

            XfireContact xcontact = (XfireContact) CoreService._Clans[nClanIndex]._Contacts.elementAt(i);
    ...
    private void HandleBuddyStatus(byte[] pBuffer, int MsgSize) {
        ...
        if (users_id_buffersize == -1) {
            ...
            System.out.println("HandleBuddyStatus attribute userid not found");
            return;
        }
        ...
        if (users_sid_buffersize == -1) {
            ...
            System.out.println("HandleBuddyStatus attribute usersid not found");
            return;
        }
        ...
        for (int i = 0; i < users_sid_buffersize / 16; i++) {
            ...
            XfireContact xcontact = null;
            xcontact = CoreService.getContactByUSERID(dwUserID);



            if (xcontact == null) {

                System.out.println("call to get Clan memberrrrrr return NULL");
            ...
            if (!bOnline) {
                ...
                service.getEventListener().Removefriend(dwUserID, name);
                ...
                if (xcontact._cNickname != null) {
                    ...
                    service.getEventListener().friendFound(dwUserID, new String(xcontact._cUsername), name);
            ...
            if (pBuffer[ptr + 0] == 'p' && pBuffer[ptr + 1] == 'e'
                ...
                if (pBuffer[ptr + 0] == 'm' && pBuffer[ptr + 1] == 's'
                    ...
                    if (msgtype == 3) {
                        ...
                        XfireContact xcontact = CoreService.getContactBySID(sid);
    ...
    void HandleAuth(byte[] pBuffer, int MsgSize) throws IOException {
        ...
        if (salt[0] == 's' && salt[1] == 'a' && salt[2] == 'l'
            ...
            System.arraycopy(_username.getBytes(), 0, cPacket, 13, _username.length());
