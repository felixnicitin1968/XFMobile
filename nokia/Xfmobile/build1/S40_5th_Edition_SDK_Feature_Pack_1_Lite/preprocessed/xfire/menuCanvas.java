...
public class menuCanvas extends Canvas implements CommandListener
{
	...
	String[] options={"Change Status","Change Nickname","Log Off"};
	...
	public void keyPressed(int keyCode)
	{
		...
		case Canvas.UP:
			...
			break;
		case Canvas.DOWN:
			if(selectedRowPos <2) selectedRowPos ++;
			break;
	...
	private void gotoModule() {
		switch(selectedRowPos) {
			case 0: //display.setCurrent(new Module1Canvas(this));
				// Module1
                              System.out.println("chanage status\n");
                              new MyStatusForm( this.mainCanvas).show();
				break;
			case 1: //display.setCurrent (new Module2Canvas(this));
				//Module2
				...
				break;
			case 2: //display.setCurrent (new Module3Canvas(this));
				//Module13
