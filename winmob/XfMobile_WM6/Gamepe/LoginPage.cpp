...
//	GetDlgItem(IDC_SIGNIN_BUTTON)->EnableWindow(FALSE);
	...
	if (!pThread)
	{
		...
		AfxMessageBox(L"CClientThread AfxBeginThread Failed!!!CRITICAL ERROR \n");
		return;
	}
...
void CLoginPage::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	// TODO: Add your message handler code here and/or call default
OutputDebugString(L"OnChar OnChar OnChar \n");
	CXPropertyPage::OnChar(nChar, nRepCnt, nFlags);
}
