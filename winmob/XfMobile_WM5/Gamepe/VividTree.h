...
// Attributes
	...
	virtual void  SetOnlineIcon( HICON icon ) { m_icon = icon; }; // Overridable
	virtual HICON GetOnlineIcon( HTREEITEM item ); // Overridable

    void  SetAwayIcon( HICON icon ) { m_awayicon = icon; }; // Overridable
	 HICON GetAwayIcon( HTREEITEM item ){return m_awayicon;}

	 void  SetPersonIcon( HICON icon ) { m_personicon = icon; }; // Overridable
	 HICON GetPersonIcon( HTREEITEM item ){return m_personicon;}
...
private:
	...
	HICON m_icon,m_awayicon,m_personicon;
