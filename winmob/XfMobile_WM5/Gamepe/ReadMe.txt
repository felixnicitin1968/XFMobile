================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Gamepe Project Overview
===============================================================================

The application wizard has created this Gamepe application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Gamepe application.
...
Gamepe.h
    ...
    project specific headers and declares the CGamepeApp application class.
...
GamepeDlg.h, GamepeDlg.cpp - the dialog
    These files contain your CGamepeDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Gamepe.pch and a precompiled types file named StdAfx.obj.
